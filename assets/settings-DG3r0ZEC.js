const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/SettingsPanel-C2aDEDaP.js","assets/index-DoYxEhAP.js","assets/chunk-QTnfLwEv.js","assets/raw-data-DXySxYhg.js","assets/ui-BOSgEfyK.js","assets/constants-B26xLSZm.js","assets/reactivity.esm-bundler-mCHFN0w4.js","assets/runtime-core.esm-bundler-CF3jp_8T.js","assets/index-LTCZ9dNd.css","assets/ModalPanel-C0LBWAHN.js","assets/ModalPanel-C-tlb-iB.css","assets/file-BswdcShs.js","assets/SettingsPanel-CHeGjNu_.css","assets/TypographyPanel-BbuMqqs9.js","assets/ToggleSwitch-CsfadXYL.js","assets/ToggleSwitch-BUb8uJ_u.css","assets/styles-ISgwm6Ns.js","assets/TypographyPanel-CM2C1-vZ.css"])))=>i.map(i=>d[i]);
import{n as e}from"./chunk-QTnfLwEv.js";import{_ as t}from"./reactivity.esm-bundler-mCHFN0w4.js";import{A as n}from"./runtime-core.esm-bundler-CF3jp_8T.js";import{V as r,d as i,j as a,p as o}from"./index-DoYxEhAP.js";var s={fontSize:null,fontFamily:`Literata, Georgia, serif`,lineHeight:1.6,theme:null,margin:24,letterSpacing:0,paragraphSpacing:1.2,textAlign:`left`,contrast:`normal`,readingMode:`pagination`,paginationAnimation:`fade`,customTypography:!1,useCustomColors:!1,customBgColor:`#fdfcfb`,customTextColor:`#1f1a17`,customBgImage:void 0,customBgImageRepeat:`no-repeat`,customBgImageSize:`cover`,customFontFamily:void 0};function c(e,t,n){let r,i,o,s;if(e){let n=a.get(e);r=n.content.background,i=n.content.text,e===`dark`&&t&&(t===`soft`?(r=`#2a2a2a`,i=`#d0d0d0`):t===`high`&&(r=`#000000`,i=`#ffffff`)),o=n.content.textSecondary??(e===`dark`?`rgba(255,255,255,0.6)`:`rgba(0,0,0,0.55)`),s=n.content.borderSubtle??(e===`dark`?`rgba(255,255,255,0.1)`:`rgba(0,0,0,0.08)`)}else r=`#fdfcfb`,i=`#1f1a17`,o=`rgba(0,0,0,0.55)`,s=`rgba(0,0,0,0.08)`;n?.bg&&(r=n.bg),n?.text&&(i=n.text);let c=n?.bgImage?`
