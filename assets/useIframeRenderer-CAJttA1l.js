var e={light:{background:`#ffffff`,text:`#333333`},dark:{background:`#1a1a1a`,text:`#e0e0e0`},sepia:{background:`#f4ecd8`,text:`#5b4636`}};function t(e,t){let n=null,i=e=>{!t||!e.data||e.data.type!==`link-click`||t(e.data.href)};function a(a){let o=e.value;if(!o||(n=o.contentDocument||o.contentWindow?.document||null,!n))return;let s=r(),c=t?`<script>
      (function() {
