...
// Chapter is now provided by @book/engine
import type { Chapter } from "@book/engine";
export type { Chapter };

// BookParser types now provided by @book/parser
import type { BookParser, ParserResult, ChapterData } from "@book/parser";
